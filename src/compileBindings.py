...
def _buildCustomFile(args, item):
  """Compile a custom code binding without PCH to avoid V8 header conflicts."""
...
def compileCustomCodeBindings(args):
  ...
  Compiling without PCH avoids these conflicts.
  """
  filesToBuild = []
  ...
  with multiprocessing.Pool(processes=multiprocessing.cpu_count()) as p:
    p.map(partial(_buildCustomFile, args), sorted(filesToBuild))
